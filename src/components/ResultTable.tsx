...
const seriesKey = (H: number) => Math.floor(H / 50) * 50;   // 시리즈 = 춤 50mm 밴드
  ...
  return (
    <div className="tablewrap">
      <table className="design-table">
        <thead>
          <tr>
            <th rowSpan={2} className="col-name gcol g-info">단면치수</th>
